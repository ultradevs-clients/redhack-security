...
const benifits = [
	...
	},
	{
		...
		img: img2,
		decs: "By incorporating cutting-edge AI and natural language processing (NLP) models, we automate repetitive security tasks and complex decision-making processes. This significantly reduces human error and enhances the precision and reliability of your continuous security testing, delivering more dependable and actionable results.",
		decs2: "Our platform offers a robust and standardized built-in framework designed to deliver consistent and repeatable penetration testing. It systematically benchmarks the latest attack tactics, techniques, and procedures (TTPs), security controls, and organizational processes — ensuring your security posture is rigorously evaluated against industry-leading standards.",
	},
	{
		id: 3,
		...
		img: img3,
		decs: "Utilizing powerful real-time data analytics, our platform swiftly identifies complex attack patterns and anomalies that traditional methods often miss. This proactive approach allows us to predict potential exploits before they occur, helping you stay one step ahead of emerging threats.",
		decs2: "Our platform offers a robust and standardized built-in framework designed to deliver consistent and repeatable penetration testing. It systematically benchmarks the latest attack tactics, techniques, and procedures (TTPs), security controls, and organizational processes — ensuring your security posture is rigorously evaluated against industry-leading standards.",
	},
	{
		id: 4,
	...
	},
	{
		...
		img: img5,
		decs: "Designed to meet the demands of large enterprises, our platform excels at handling extensive data analysis and security operations at scale. Real-time classification of true and false positives enables efficient prioritization, making it easier to manage and reduce your attack surface regardless of your organization’s size.",
		decs2: "Our platform offers a robust and standardized built-in framework designed to deliver consistent and repeatable penetration testing. It systematically benchmarks the latest attack tactics, techniques, and procedures (TTPs), security controls, and organizational processes — ensuring your security posture is rigorously evaluated against industry-leading standards.",
	},
	{
		id: 6,
		...
		img: img6,
		decs: "Our penetration testing and security validation services are highly adaptable, aligning closely with your unique business goals and security requirements. This flexibility empowers you to select the most effective testing methodologies and solutions tailored specifically to your environment.",
		decs2: "Our platform offers a robust and standardized built-in framework designed to deliver consistent and repeatable penetration testing. It systematically benchmarks the latest attack tactics, techniques, and procedures (TTPs), security controls, and organizational processes — ensuring your security posture is rigorously evaluated against industry-leading standards.",
	},
	{
		id: 7,
		...
		decs: "We continuously measure your security posture against established industry standards and peer organizations. This benchmarking provides valuable insights into your relative risk exposure and helps you identify areas for improvement in an ever-evolving threat landscape.",
		decs2: "Our platform offers a robust and standardized built-in framework designed to deliver consistent and repeatable penetration testing. It systematically benchmarks the latest attack tactics, techniques, and procedures (TTPs), security controls, and organizational processes — ensuring your security posture is rigorously evaluated against industry-leading standards.",
	},
	{
		id: 8,
...
export default function RedhackSecurity() {
	...
	return (
		<div className="lg:py-20 py-12 text-center bg-accent border-t border-background/10 text-background lg:px-0 px-5">
			<div className="container">
				<h2>Redhack Security Penetration Testing Benifits</h2>

				<div className="bg-background/10 hidden mt-10 md:grid grid-cols-4 w-full overflow-x-auto mx-auto rounded-lg ">
				...
				<section className="flex flex-col lg:flex-row w-full gap-12 py-6 lg:mb-32 ">
					...
					<div className="lg:w-2/4 text-left py-3">
						...
						<p className="text-justify opacity-70 !py-0 leading-relaxed">
							{currentService.decs2}
						</p>
					</div>
				</section>
			</div>
